...
import { CategoryAdd, CategoryDelete, CategoryListGet, CategoryUpdate, PosterDelete, PosterStatusChange, getPosterList } from "../../../services/book.service";
...
const Poster = (props) => {
  ...
  const posterLists = async() => {
    let result = await getPosterList()
    if(result.status){
  ...
  const handleCurrencyDelete = async(row) => {
    ...
    let result  = await PosterDelete(data)
  ...
  return (
    <>
                  ...
                  <div class="card-header">
                    ...
                    <div class="dropdown">
                      ...
                      >
                        ...
                        <CSVLink class="dropdown-item" data={posterList}>
                          Expoprt as CSV
                        </CSVLink>
                      </div>
                      <button
      ...
      <AddPoster categoryList={categoryList} callingPosterApiAgainAfterAddNewOne={posterApi}/>
      <UpdatePoster categoryDetails = {categoryIdForUpdate} callingPosterApiAgainAfterAddNewOne={posterApi}/>
      {/* Currency Pair modal data */}
    </>
  );
};
